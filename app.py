...
predictor = Predictor(use_home_advantage, use_recent_form, use_goals_model, use_head_to_head,
use_machine_learning, use_injury_lineup, use_league_standing, use_xg_model)
